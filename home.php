...
<main id="home">
      ...
      <div class="carousel-item banner-1 active">
        <div class="container">  
          <div class="carousel-caption">
            ...
            <p><a class="btn btn-lg btn-success background-color-green" href="#">Learn More</a></p>
          </div>
        </div>
      </div>
  ...
  <div class="container marketing">
    ...
    <div class="pricing-header p-3 pb-md-4 mx-auto text-center" id="admissions">
      ...
      <p class="fs-5">
      Our admissions process is now powered by a decision-support system called - <span class="green-bold">forecast</span>.
      </p>
      <p><a class="btn btn-lg btn-success background-color-green text-center" href="#">Apply Now</a></p>
    </div>
    ...
    <div class="container px-4" id="featured-3">
      ...
      <div class="row g-4 py-2 row-cols-1 row-cols-lg-3">
        ...
        <div class="feature col">
          ...
          <h2>Hassle-Free</h2>
          <p class="justify">Students can send the application online in the comfort of their homes.</p>
        </div>
        <div class="feature col">
          <div class="feature-icon bg-primary bg-gradient background-color-green">
    ...
    <div class="row faculty">
      ...
      <div class="col-lg-4">
        <img src="./img/faculty/ballaho.png" alt="" class="bd-placeholder-img rounded-circle" width="140" height="140">
  ...
  <footer class="container">
    ...
    <p>&copy; 2022 Forecast, Jaydee C. Ballaho &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
  </footer>
</main>
